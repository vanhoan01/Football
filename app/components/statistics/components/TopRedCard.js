...
const TopYellowCard = ({redcard}) => {
  let data = redcard?.item;
  ...
  var redcard = data.statistics?.cards.red.toString();
  return (
    <View style={styles.rootView}>
      <View>
        <Text style={styles.firstText}>Thẻ đỏ</Text>
      </View>
      ...
      <View style={styles.viewTong}>
        ...
        <View style={styles.root}>
          ...
          <View style={styles.viewGoal}>
            <Text style={styles.textGoal}>{redcard}</Text>
          </View>
        </View>
        <View style={styles.viewTong2}>
          <View style={styles.view}></View>
